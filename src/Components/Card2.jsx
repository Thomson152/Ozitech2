...
const Card2 = () => {
  return (
    <div className="w-[414px] border h-[308px] rounded-lg mr-4 border-black shadow">
      <div className="para">
        <p className="font-normal Poppins max-w-[19rem] text-[15px]  m-7">
      ...
      <div className="m-5 flex items-center">
        ...
        <div className="ml-4">
          <h2 className="text-[15px] Poppins text-black font-normal">Thomas Scot </h2>
          <h1 className="text-[12px] Poppins text-black font-light">
            CEO marketing Dax
          </h1>
        </div>
      </div>
